...
export const metadata: Metadata = {
  title: "Webild: Build Modern Web Experiences",
  description: "Explore Webild for crafting exceptional digital experiences. Join our newsletter for the latest updates.",
  openGraph: {
    title: "Webild: Build Modern Web Experiences",
    description: "Explore Webild for crafting exceptional digital experiences. Join our newsletter for the latest updates.",
    siteName: "Webild"
  ...
  twitter: {
    ...
    title: "Webild: Build Modern Web Experiences",
    description: "Explore Webild for crafting exceptional digital experiences."
  },
  robots: {
    index: true,
    follow: true
